...
class Cvolution(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_q = nn.Conv2d(channels, channels, kernel_size=3, padding=kernel_size // 2, groups=4, bias=False)
    ...
    def forward(self, x):  # (3,256,7,7)
        ...
        out = _Cvolution((x * avg_x.expand_as(x)), weight, stride=self.stride,
